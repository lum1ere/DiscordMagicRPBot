from app.variables import get_token, get_db, get_logs_db
...
guilds = [
    ...
    #discord.Object(id=1054307149754417243),
    discord.Object(id=925510858111598622),
    discord.Object(id=890203457041088532),
